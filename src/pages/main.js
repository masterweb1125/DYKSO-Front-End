  ...
  const CaptureRef = useRef();
    ...
    const UploadAttachments = async (event) => {
      if (event.target.files && event.target.files[0]) {
        ...
        console.log("capturing a picture")
      }
      }
    ...
    return (
      <div
        ...
        style={{ width: "100%", background: "#BBBBBB" }}
      >
        ...
        <div className="row" style={{ height: "70vh" }}>
          <div className="col-12 col-md-6 d-flex flex-column justify-content-center bg-light h-100">
            <div
              className="d-flex align-items-center flex-grow-1 main-con mt-4"
            ...
            <div
              className="d-flex align-items-center flex-grow-1 main-con mb-4 mt-4"
